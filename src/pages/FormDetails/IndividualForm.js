  ...
  return (
    <div>
      ...
      <div className="info">
        ...
        <p> <strong>Date:</strong> {dateFormat(form.date, "paddedShortDate")}</p>
        <p> <strong>Programs:</strong> {form?.programs?.join(', ')}</p>
        <p> <strong>Associated Youth:</strong></p>
        <div className="indent">
          <p>Name: {form?.associated_youth?.firstName} {form?.associated_youth?.lastName}</p>
          <p>email: {form?.associated_youth?.email} </p>
        </div>
        <p> <strong>Associated Event:</strong> </p>
        <div className="indent">
